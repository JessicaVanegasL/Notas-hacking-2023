...
| Comando | Descripción |
|------------|-------------|
|  cron |  Permite iniciar los procesos ejecuntandolos segun la programación, ose que son intervalos de tiempo: suelen estan en: /etc/cron.d   |
|man cron| Es un demonio que se arranca y ejecuta comandos|
|cron job| Depende de los asterisco se ejecutan **Hora,Día,Mes,Mes-Día**|
