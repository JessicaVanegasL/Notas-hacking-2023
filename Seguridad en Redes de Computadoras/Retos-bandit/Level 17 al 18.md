...
| Comando | Descripción |
|------------|-------------|
|  diff | Comando para comparar directorios entre si o ficheros línea a línea  |

## Referencias

[diff](https://geekland.eu/comparar-directorios-y-archivos-comando-diff-linux/#:~:text=diff%3A%20Es%20la%20utilidad%20para,est%C3%A1n%20dentro%20del%20directorio%20analizado.)
